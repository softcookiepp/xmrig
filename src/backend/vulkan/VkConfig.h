...
public:
    ...
    VkPlatform platform() const;
    rapidjson::Value toJSON(rapidjson::Document &doc) const;
    std::vector<VkLaunchData> get(const Miner *miner, const Algorithm &algorithm, const VkPlatform &platform, const std::vector<VkDevice> &devices) const;
    ...
    inline const Threads<VkThreads> &threads() const   { return m_threads; }
