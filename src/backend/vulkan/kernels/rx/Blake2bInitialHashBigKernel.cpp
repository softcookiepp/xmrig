...
void xmrig::Blake2bInitialHashBigKernel::enqueue(tart::device_ptr queue, size_t threads)
{
...
void xmrig::Blake2bInitialHashBigKernel::setArgs(tart::buffer_ptr out, tart::buffer_ptr blockTemplate)
{
