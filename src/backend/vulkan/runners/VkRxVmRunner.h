...
class VkRxVmRunner : public VkRxBaseRunner
{
public:
    XMRIG_DISABLE_COPY_MOVE_DEFAULT(VkRxVmRunner)

    VkRxVmRunner(size_t index, const VkLaunchData &data);
    ~VkRxVmRunner() override;
