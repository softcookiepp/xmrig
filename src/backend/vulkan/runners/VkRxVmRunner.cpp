...
#include "backend/vulkan/kernels/rx/InitVmKernel.h"
...
xmrig::VkRxVmRunner::VkRxVmRunner(size_t index, const VkLaunchData &data) : VkRxBaseRunner(index, data)
{
}
...
size_t xmrig::VkRxVmRunner::bufferSize() const
{
    return VkRxBaseRunner::bufferSize() + (align(2560 * m_intensity));
}


void xmrig::VkRxVmRunner::build()
{
...
void xmrig::VkRxVmRunner::execute(uint32_t iteration)
{
