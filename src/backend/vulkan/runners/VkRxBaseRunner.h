...
class VkRxBaseRunner : public VkBaseRunner
{
public:
    XMRIG_DISABLE_COPY_MOVE_DEFAULT(VkRxBaseRunner)

    VkRxBaseRunner(size_t index, const VkLaunchData &data);
    ~VkRxBaseRunner() override;
