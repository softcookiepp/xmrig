...
uint64_t xmrig::VkSharedData::adjustDelay(size_t /*id*/)
{
    if (m_threads < 2) {
        return 0;
    }
...
uint64_t xmrig::VkSharedData::resumeDelay(size_t /*id*/)
{
    if (m_threads < 2) {
        return 0;
    }
...
void xmrig::VkSharedData::setResumeCounter(uint32_t value)
{
    if (m_threads < 2) {
        return;
    }
...
void xmrig::VkSharedData::setRunTime(uint64_t time)
{
