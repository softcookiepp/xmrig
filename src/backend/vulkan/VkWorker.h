...
class VkWorker : public GpuWorker
{
public:
    XMRIG_DISABLE_COPY_MOVE_DEFAULT(VkWorker)

    VkWorker(size_t id, const VkLaunchData &data);
...
private:
    ...
    const Miner *m_miner;
    IVkRunner *m_runner = nullptr;
    VkSharedData &m_sharedData;
    WorkerJob<1> m_job;
};
